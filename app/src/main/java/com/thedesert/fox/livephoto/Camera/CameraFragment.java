...
public class CameraFragment extends Fragment implements View.OnClickListener{
    ...
    private TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture,
            ...
            openCamera(width, height, REAR_CAMERA);
        }
    ...
    private void openCamera(int width, int height, int camera) {
    ...
    public void convertVideoToGif(String videoAbsolutePath) {
        FFmpeg ffmpeg = FFmpeg.getInstance(getActivity());
        String[] cmd;

        File temp_video = new File(videoAbsolutePath);
        String dir = temp_video.getParentFile().getAbsolutePath();
        String filename = temp_video.getName();
        cmd = new String[]{
                "-ss",
                "00:00:00",
                "-i",
        ...
        try{
            ...
            Log.e("FFMPEG","WHY ARE YOU RUNNING?!");
        }

        cmd = new String[]{
                "-i",
                videoAbsolutePath,
                removeExtension(videoAbsolutePath) +".gif",
                "-hide_banner"};
        try{
            ffmpeg.execute(cmd, new ExecuteBinaryResponseHandler());
        }catch (FFmpegCommandAlreadyRunningException e){
        ...
        while(ffmpeg.isFFmpegCommandRunning()){
            try {
                ...
                Log.e("wait", "I don't even");
            }
        }

        //boolean deleted = temp_video.delete();
